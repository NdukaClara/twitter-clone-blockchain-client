...
const style = {
  wrapper: `flex-[2] p-4 ml-5`,
  searchBar: `sticky top-0 bg-[#15202b] z-10 flex items-center bg-[#243340] p-2 rounded-3xl`,
  ...
  showMore: `p-2 text-[#1d9ba6] text-xs font-semibold cursor-pointer`,
